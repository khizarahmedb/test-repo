    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="no-scrollbar bg-[#0a0a14] text-white border border-[#5D43E1] max-h-[90vh] overflow-y-auto max-w-xl w-full rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <Button
            onClick={handleSave}
            className="hover:bg-white hover:bg-none hover:text-black rounded-[12px] bg-[linear-gradient(90deg,rgba(255,255,255,0.2)_0%,rgba(255,255,255,0)_22.94%,rgba(255,255,255,0)_72.33%,rgba(255,255,255,0.2)_100%),linear-gradient(119deg,#5D43E1_12.9%,#AB51DE_86.02%)]"
            disabled={isUploading}
          >
            Save
          </Button>
